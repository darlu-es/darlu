...
<div id="selectFormat">
	...
	foreach ($rs as $format) {
		?>
		<div class="format" data-format="<?php echo S::safeHTML($format['outputformat']);?>" style="background-image:url('<?php echo \FM::getFileIconURL(false, $format['outputformat']);?>')">
			<div class="name"><?php echo S::safeHTML(strtoupper($format['outputformat']));?></div>
		</div>
	<?php
	}
	?>
